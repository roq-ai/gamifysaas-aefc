...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`GamifySaaS`}</title>

        <meta
          name="description"
          content="Unlock your full learning potential with GamifySaaS - transforming online education through gamification, motivating every user to complete their online courses on platforms like Udemy, Coursera, and more."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517414204284-fb7e98b2e255?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYW1pZmljYXRpb258ZW58MHx8fHwxNjk0MDExOTY2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@filios_sazeides?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Filios Sazeides`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock your full learning potential with GamifySaaS - transforming online education through gamification, motivating every user to complete their online courses on platforms like Udemy, Coursera, and more.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Manager" type="manager" abilities={appConfig.ownerAbilities} />
