...
import { getEducationProviderById } from 'apiSdk/education-providers';
...
function EducationProviderViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Education Provider Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('education_provider', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/education-providers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="education_provider" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
